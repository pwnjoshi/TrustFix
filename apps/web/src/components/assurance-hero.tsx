...
export function AssuranceHero() {
  ...
  return <section className="hero-v3">
    ...
    <div className="hero-v3-copy">
      ...
      <div className="hero-actions"><Link className="button primary luminous" href="/demo">Explore interactive demo <ArrowRight/></Link><a className="button dark-outline" href="/app">Start for free</a></div>
